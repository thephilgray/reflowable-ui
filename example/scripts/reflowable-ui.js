...
Exercise.prototype.removeComponent = function removeComponent(name, index){
    delete this.components[name][index];
}
...
function Quiz(selector, options) {
    ...
    this.types = {
        ...
        'match-pairs': {
            // match-pairs is actually exactly like word-order except the compare function
            before: function () {
            ...
            transitions: _.merge({}, this.transitions, {
                [INITIAL]: {
                    'answer-slot': {
                        effects: function (el, i) {
